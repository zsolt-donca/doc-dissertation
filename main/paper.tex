...
\titleRO{%
Implementarea unei aplica\c{t}ii interactive folosind programare reactivã în Scala \c{s}i facilitarea test\u{a}rii func\c{t}ionale a aplica\c{t}iilor Swing 
}
