...
\subsubsection{Interaction between the components --- example}

Figure \ref{fig:scomm_event_propagation} shows the interaction between the components of a directory list when the user changes the current directory. It consists of four steps:
\begin{enumerate}
