...
\begin{itemize}
\item a brief explanation of the test framework (\fullref{sec:fest-swing})
\item a common design pattern associated with UI tests (\fullref{sec:user-actions-adapters})
\item the features of the extension framework
	\begin{itemize}
	\item \fullref{sec:test-auditing}
	\item \fullref{sec:edt-dispatch}
	\item \fullref{sec:simulated-dnd}
	\end{itemize}
\item \fullref{sec:nfr}
\end{itemize}

\noindent The main features of the extension framework are the following:
\begin{itemize}
\item test auditing (\fullref{sec:test-auditing}):
	\begin{itemize}
...
\begin{itemize}
\item automatic thread dispatch (\fullref{sec:edt-dispatch}):
	\begin{itemize}
...
\item simulated drag-and-drop (\fullref{sec:simulated-dnd}):
	\begin{itemize}
